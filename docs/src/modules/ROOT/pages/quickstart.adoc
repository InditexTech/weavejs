...
=== Step 2: Setup the _Next.js_ custom server
...
=== Step 3: Install the Weave.js backend dependencies
...
=== Step 4: Setup the Weave.js backend logic

TODO

=== Step 5: Install the Weave.js frontend dependencies

TODO

=== Step 6: Setup the Weave.js frontend
