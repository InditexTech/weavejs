...
[source,typescript]
----
include::ROOT:example$app/room/roomId/page.tsx[]
----
...
[source,typescript]
----
include::ROOT:example$components/utils/constants.ts[]
----
...
<5> Define the custom plugins we'll use on this example. By default the xref:react:weave-provider.adoc[WeaveProvider]
...
[source,typescript]
----
include::ROOT:example$hooks/use-handle-route-params.ts[]
----
...
[source,typescript]
----
include::ROOT:example$hooks/use-get-websockets-store.ts[]
----
...
[source,typescript]
----
include::ROOT:example$hooks/use-get-weave-js-props.ts[]
----
...
[source,typescript]
----
include::ROOT:example$hooks/use-context-menu.ts[]
----
...
[source,typescript]
----
include::ROOT:example$components/room/room.tsx[]
----
...
[source,typescript]
----
include::ROOT:example$components/room/room.layout.tsx[]
----
...
[source,typescript]
----
include::ROOT:example$components/room/room-loader.tsx[]
----
...
[source,typescript]
----
include::ROOT:example$components/overlays/connected-users.tsx[]
----
...
[source,typescript]
----
include::ROOT:example$components/overlays/connection-status.tsx[]
----
...
[source,typescript]
----
include::ROOT:example$components/overlays/room-information-overlay.tsx[]
----
...
[source,typescript]
----
include::ROOT:example$components/overlays/room-users-overlay.tsx[]
----
...
[source,typescript]
----
include::ROOT:example$components/overlays/toolbar-button.tsx[]
----
...
[source,typescript]
----
include::ROOT:example$components/overlays/toolbar.tsx[]
----
...
[source,typescript]
----
include::ROOT:example$components/overlays/tools-overlay.tsx[]
----
...
[source,typescript]
----
include::ROOT:example$components/overlays/zoom-handler-overlay.tsx[]
----
...
[source,typescript]
----
include::ROOT:example$components/context-menu/context-menu.tsx[]
----
...
Let's now xref:ROOT:quickstart.adoc#_step_5_run_the_project[run the project] to test the full integration.
