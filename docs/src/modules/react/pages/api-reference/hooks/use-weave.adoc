...
The store is based on https://zustand.docs.pmnd.rs/learn/getting-started/introduction[Zustand] state
...
Being the store based on https://zustand.docs.pmnd.rs/learn/getting-started/introduction[Zustand],
usage is pretty straight-forward, we just instantiate the hook and we pass a function as parameter,
that receives the state as parameter and from there we can reduce to the part of the state we need,
like this:
