...
The store is based on https://zustand.docs.pmnd.rs/getting-started/introduction[Zustand] state
...
Being the store based on https://zustand.docs.pmnd.rs/getting-started/introduction[Zustand],
