...
[source,json]
----
include::quickstart:example$tsconfig.server.json[]
----
+
...
[source,json]
----
include::quickstart:example$nodemon.json[]
----
...
[source,typescript]
----
include::quickstart:example$server.ts[]
----
...
[source,typescript]
----
include::quickstart:example$persistence.ts[]
----
...
[source,typescript]
----
include::quickstart:example$server.mod-1.ts[]
----
...
Let's now setup the xref:quickstart:frontend.adoc[frontend side] of the application.
