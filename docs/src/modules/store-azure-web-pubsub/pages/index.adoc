= Overview
:description: Getting started with Weave.js Azure Web PubSub store

The Azure Web PubSub Store is a store for Weave.js that uses the https://azure.microsoft.com/es-es/products/web-pubsub[Azure Web PubSub]
...
https://expressjs.com/[Express] service.
