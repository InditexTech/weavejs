...
Use
https://zustand.docs.pmnd.rs/learn/getting-started/introduction[Zustand] for this.

* Install the https://zustand.docs.pmnd.rs/learn/getting-started/introduction[Zustand] dependency:
+
[source,shell]
----
npm install zustand
