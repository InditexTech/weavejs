...
.xref:main:build/nodes/star.adoc[Arrow]
...
[card,subheader="Drawing",labels="deprecated"]
.xref:main:build/nodes/line.adoc[Line]
...
[card,subheader="Drawing",labels="deprecated"]
.xref:main:build/nodes/regular-polygon.adoc[Regular Polygon]
...
In Weave.js a Node is a class that extends the https://github.com/InditexTech/weavejs/blob/main/code/packages/sdk/src/nodes/node.ts[WeaveNode]
...
To create a custom node, create a class that extends the https://github.com/InditexTech/weavejs/blob/main/code/packages/sdk/src/nodes/node.ts[WeaveNode]
...
Our xref:sdk:api-reference/nodes/node.adoc[WeaveNode] base class extend the `Konva.Node` class to define several functions:
...
my its children and not its parents, check how the https://github.com/InditexTech/weavejs/blob/main/code/packages/sdk/src/nodes/frame/frame.ts[Frame]
