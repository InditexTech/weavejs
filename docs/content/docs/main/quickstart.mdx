...
- A backend server that handles real-time synchronization using a Weave.js Store provider.
- A Next.js frontend application powered by Weave.js to render a collaborative canvas with live updates.
...
In this case, we will use the [Weave.js Store WebSockets](/docs/main/build/stores/websockets-store).
