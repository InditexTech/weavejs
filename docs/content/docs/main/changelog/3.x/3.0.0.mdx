---
title: v3.0.0
description: Support to define different render / reconciler, improved UX on Image Tool, avoid usage of `window.weave` properties on Video and Text tools and performance improvements on basic operations
---
