---
title: v5.0.0
description: Allow to edit groups without un-grouping them, Rectangle and Ellipse internal labels, New Polygon Node, Store lifecycle changes, removed use of @syncedstore/core and new alpha API to manipulate document state from server-side on a low-level mode and minor fixes to stroke node and brush tool to improve usability
---
