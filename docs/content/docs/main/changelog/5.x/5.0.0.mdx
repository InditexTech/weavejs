---
title: v5.0.0
description: Refactor Image and Image tools to avoid saving fallback image into room state, Store lifecycle changes, removed use of @syncedstore/core and new alpha API to manipulate document state from server-side on a low-level mode  and minor fixes to stroke node and brush tool to improve usability
---
