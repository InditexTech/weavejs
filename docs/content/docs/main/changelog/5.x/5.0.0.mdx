---
title: v5.0.0
description: Store lifecycle changes, removed use of @syncedstore/core and new alpha API to manipulate document state from server-side on a low-level mode
---
