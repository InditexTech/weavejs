---
title: Regular Polygon Tool (deprecated)
description: Add a regular polygon to the canvas
---

<Callout type="warn" title="Deprecated">
  This action is deprecated. Use the [Polygon Tool](/docs/main/build/actions/polygon-tool) action instead.
</Callout>

![Regular Polygon Tool action on use on the Weave.js showcase](/images/actions/regular-polygon-tool.gif)
