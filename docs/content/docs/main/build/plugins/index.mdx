...
<Card href="/docs/main/build/plugins/users-presence" title='Users Presence'>

Displays what users are doing on the canvas. For example when dragging or transforming
an element.
...
<Card href="/docs/main/build/plugins/comments-renderer" title='Comments Renderer'>
...
<Card href="/docs/main/build/plugins/nodes-multi-selection-feedback" title='Nodes Multi-Selection'>
