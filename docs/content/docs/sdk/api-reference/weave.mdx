...
```ts
moveNode(node: WeaveStateElement, position: WeavePosition, doRender = true): void
```
...
This method locks the provided node, locks means to set an attribute named `locked` to `true` and in
that state, nodes cannot be selected, dragged or transformed.
...
This method locks the provided nodes, locks means to set an attribute named `locked` to `true` and in
that state, nodes cannot be selected, dragged or transformed.
...
This method unlocks the provided node, unlocks means to set an attribute named `locked` to `false` and in
that state, nodes can be selected, dragged or transformed.
...
This method unlocks the provided nodes, unlocks means to set an attribute named `locked` to `false` and in
that state, nodes can be selected, dragged or transformed.
