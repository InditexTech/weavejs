...
This method exports the whole stage (all nodes on the canvas) as
an image. You can define the exportation options.
...
This method exports the specified node as an image. You can define the
exportation options.
