...
<TypeTable
  type={{
    ...
    ["getImageBase64"]: {
      ...
      type: "(instance: Weave, nodes: Konva.Node[]) => Promise<string>",
    },
  }}
/>
...
<TypeTable
  type={{
    ["canPasteOnto"]: {
      ...
      type: "WeaveCanPasteOntoFunction",
      default: "WEAVE_COPY_PASTE_CONFIG_DEFAULT.canPasteOnto",
    },
    ["paddingOnPaste"]: {
      description: "Allows to add a padding when pasting internally.",
      type: "PaddingOnPaste",
      default: "{ enabled: false, paddingX: 0, paddingY: 0 }",
    },
  }}
/>
...
If the [Clipboard API](https://developer.mozilla.org/en-US/docs/Web/API/Clipboard_API) is no supported
