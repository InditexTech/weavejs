...
<Card href="/docs/main/build/stores/standalone-store" title='Standalone Store'>

An store that directly render a room, useful when trying to render a room server-side to export
as image.
